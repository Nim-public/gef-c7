# Handoff — Week 22 Advanced Inference Decoding: Deep Expansion Phase
...
| `01-speculative-decoding.md` | topic deep-dive |
| `02-grammar-constrained-decoding.md` | topic deep-dive |
| `03-gguf-quantization-ecosystem.md` | topic deep-dive |
| `04-practice-decoding-lab.md` | topic deep-dive |
...
#### `01-speculative-decoding.md` → subfolder `01-speculative-decoding/`

Deep-dive files to create (suggested titles — refine as you write):

1. Draft/verify loop — the acceptance theorem
2. Speed math — k_eff, cost ratio, slowdown cases
3. vLLM/HF flags — running and measuring
4. Benchmarking — parity + acceptance sweeps

#### `02-grammar-constrained-decoding.md` → subfolder `02-grammar-constrained-decoding/`

Deep-dive files to create (suggested titles — refine as you write):

1. Token masking — how grammars guarantee validity
2. Outlines — Pydantic/enum/regex grammars
3. Architecture changes — retries deleted, checks kept
4. Content quality — what grammars don't fix

#### `03-gguf-quantization-ecosystem.md` → subfolder `03-gguf-quantization-ecosystem/`

Deep-dive files to create (suggested titles — refine as you write):

1. GGUF format — conversion and quant alphabet decoded
2. llama.cpp/Ollama — knobs, context, serving
3. Engine selection — llama.cpp vs vLLM vs TRT-LLM
4. Quality protocol — task evals over perplexity

#### `04-practice-decoding-lab.md` → subfolder `04-practice-decoding-lab/`

Deep-dive files to create (suggested titles — refine as you write):

1. Validity experiment — free vs retry vs grammar
2. Speed overhead — masking costs measured
3. Content verification — kept in the loop
4. Serving matrix — model×quant×engine
...
- [ ] `02-grammar-constrained-decoding/`
- [ ] `03-gguf-quantization-ecosystem/`
- [ ] `04-practice-decoding-lab/`
...
doc/Phase-3-Advanced-Extensions/Week-22-Advanced-Inference-Decoding/handoff.md and follow it completely.
